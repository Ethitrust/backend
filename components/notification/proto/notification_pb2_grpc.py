...
class NotificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Notify = channel.unary_unary(
                ...
                request_serializer=notification__pb2.NotifyRequest.SerializeToString,
                response_deserializer=notification__pb2.NotifyResponse.FromString,
...
def add_NotificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Notify': grpc.unary_unary_rpc_method_handler(
                    servicer.Notify,
                    request_deserializer=notification__pb2.NotifyRequest.FromString,
                    response_serializer=notification__pb2.NotifyResponse.SerializeToString,
            ),
    }
...
class NotificationService(object):
    ...
    def Notify(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/notification.NotificationService/Notify',
            notification__pb2.NotifyRequest.SerializeToString,
            notification__pb2.NotifyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
