"""FastAPI entry point for the Wallet service."""
...
async def lifespan(application: FastAPI):  # noqa: ANN001
    ...
    logger.info("Wallet service is starting up")
    yield
    for task in (consumer_task, grpc_task):
        ...
        try:
            ...
            pass
    logger.info("Wallet service has shut down")


app = FastAPI(
    title="Ethitrust Wallet Service",
    version="0.1.0",
    lifespan=lifespan,
)
