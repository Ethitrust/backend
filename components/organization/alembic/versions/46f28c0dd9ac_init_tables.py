...
Revision ID: 46f28c0dd9ac
Revises: 
Create Date: 2026-04-08 19:26:01.880384
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('org_id', 'name', name='uq_organization_roles_org_name')
    )
    op.create_index(op.f('ix_organization_roles_org_id'), 'organization_roles', ['org_id'], unique=False)
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('role_id', 'permission_key', name='uq_organization_role_permissions_role_permission')
    )
    op.create_index(op.f('ix_organization_role_permissions_role_id'), 'organization_role_permissions', ['role_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_organization_roles_org_id'), table_name='organization_roles')
